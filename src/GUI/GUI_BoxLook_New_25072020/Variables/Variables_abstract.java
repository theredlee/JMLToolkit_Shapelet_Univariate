...
public abstract class Variables_abstract extends Variables_declare_abstract {
    public void initializeGlobalVariables(Variables aVariables){
        ...
        this.shapeletDouble = aVariables.shapeletDouble;
        this.shapeletsWithCurrentLabel = aVariables.shapeletsWithCurrentLabel;
        ...
        this.shapeletMark_centerChart = aVariables.shapeletMark_centerChart;
        this.shapeletMark_topRightChart = aVariables.shapeletMark_topRightChart;
        this.shapeletTrace_centerChart = aVariables.shapeletTrace_centerChart;
        this.shapeletTrace_topRightChart = aVariables.shapeletTrace_topRightChart;
        this.initializeTS = aVariables.initializeTS;
        this.loadShapeletYesOrNo = aVariables.loadShapeletYesOrNo;
        ...
        this.aDoubleAryShapelets = aVariables.aDoubleAryShapelets;
        ...
        this.shapletContainer = aVariables.shapletContainer;
        ...
        this.lastTSListIndex = aVariables.lastTSListIndex;
