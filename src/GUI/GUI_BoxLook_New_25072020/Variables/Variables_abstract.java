...
public abstract class Variables_abstract extends Variables_declare_abstract {
    public void initializeGlobalVariables(Variables aVariables){
        ...
        this.SPLet_toAllTS_distances = aVariables.SPLet_toAllTS_distances;
        ...
        this.currentSPLet = aVariables.currentSPLet;
        ...
        this.SPLet_mark_centerChart = aVariables.SPLet_mark_centerChart;
        this.SPLet_mark_topRightChart = aVariables.SPLet_mark_topRightChart;
        this.SPLet_trace_centerChart = aVariables.SPLet_trace_centerChart;
        this.SPLet_trace_topRightChart = aVariables.SPLet_trace_topRightChart;
        this.initializeTS = aVariables.initializeTS;
        this.load_SPLet_YesOrNo = aVariables.load_SPLet_YesOrNo;
        ...
        this.SPLet_container = aVariables.SPLet_container;
