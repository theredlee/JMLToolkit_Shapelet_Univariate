...
public class EfficientLTS_PAASAX_Guozhong_Oldest_Version {
    ...
    public void sortSAX(ArrayList al, BitSet [] bs, int [] wb){ /*** sortSAX(Tp.starOmegaArrayList[c],Tp.BitMap[c],Tp.weightBitmap[c]); **/
        BitSet bsTemp;
        int wbTemp;
        String saxTemp;
...
//            }
    ...
    public double Learn(DataSet dataSet) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        String path = root + "/experiment_II/Shapelets/shapelet-original.txt";
...
//        String filedir = "D:\\RA\\Task4-ML\\experiment\\";
        ...
        //test path
        String root = System.getProperty("user.dir");
        String filedir = root + "\\experiment_II\\Grace_MI";
...
//            }
            ...
            EfficientLTS_PAASAX_Guozhong_Oldest_Version eLTS = new EfficientLTS_PAASAX_Guozhong_Oldest_Version();
